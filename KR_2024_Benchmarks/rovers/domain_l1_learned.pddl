...
(:requirements :strips :typing :negative-preconditions :equality)
  ...
  (:action calibrate
    :parameters (?camera1 - camera ?rover1 - rover)
    :precondition (and
      (available ?rover1)
      (equipped_for_imaging ?rover1)
      (equipped_for_rock_analysis ?rover1)
  ...
  (:action take_image
    :parameters (?camera1 - camera ?mode1 - mode ?objective1 - objective ?rover1 - rover)
    :precondition (and
      (available ?rover1)
      (calibrated ?camera1 ?rover1)
      (equipped_for_imaging ?rover1)
  ...
  (:action communicate_image_data
    :parameters (?mode1 - mode ?objective1 - objective)
    :precondition (
    )
    :effect (and
